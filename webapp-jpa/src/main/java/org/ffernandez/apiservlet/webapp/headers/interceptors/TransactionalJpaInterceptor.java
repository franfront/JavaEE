...
public class TransactionalJpaInterceptor {
    ...
    @AroundInvoke
    public Object transactional(InvocationContext invocation) throws Exception { // El Object que devuelve el método transactional es el resultado de la ejecución del método interceptado
